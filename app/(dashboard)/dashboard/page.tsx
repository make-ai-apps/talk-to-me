...
import BillingSummery from '../_components/BillingSummery';
import PricingSectionCards from '../_components/Plans';
    ...
    <div className=''>
      ...
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-7'>
        ...
        <Card className='col-span-1 lg:col-span-3'>
          ...
          <CardContent>
            <BillingSummery user={user} subscriptions={subscriptions as any} products={products} />
          </CardContent>
        </Card>
      </div>
      <PricingSectionCards
        activeProduct={(subscriptions as any)?.prices?.products?.name.toLowerCase() || ""}
        user={user} subscriptions={subscriptions as any} products={products} />
    </div>
  )
}
